...
export function PaymentsArchiveSection() {
  ...
  return (
    ...
    >
      ...
      >
        <span className={typography.cardTitle}>ארכיון לפי חודשים</span>
        <p className={`${typography.caption} mt-1 font-semibold`} style={{ color: colors.textMuted }}>
          חודשים, כפילויות ותשלומים שדורשים בדיקה
        </p>
      </summary>
      <div className="border-t px-4 pb-5 pt-4 md:px-5" style={{ borderColor: colors.borderSubtle }}>
