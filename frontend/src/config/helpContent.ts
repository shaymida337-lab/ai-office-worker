...
> = [
  ...
  },
  {
    ...
    usedFor: "איתור פערים בין תשלום, מסמך בדרייב ושורה בגוגל שיטס.",
    ...
    buttons: [
      ...
      { label: "בדוק מערכת", explanation: "בודק אם שיטס ודרייב מחוברים." },
    ],
    commonMistakes: ["להתעלם מחשבוניות חסרות.", "לצרף קישור למסמך לא נכון.", "לסמן שולם בלי חשבונית."],
    troubleshooting: ["אם אין קישור, חפש במייל לפי ספק וסכום.", "אם המסמך לא בדרייב, בדוק חיבור דרייב.", "אם הפער לא נסגר, הרץ סריקה מחדש."],
    videoUrl: null,
