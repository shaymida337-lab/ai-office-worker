...
> = [
  {
    ...
    steps: [
      "בדוק בחלק העליון שג׳ימייל, גוגל דרייב, גוגל שיטס, וואטסאפ והמסד מחוברים.",
      "אם ג׳ימייל לא מחובר, לחץ על חבר ג׳ימייל.",
      "אם וואטסאפ לא מחובר, לחץ על חבר וואטסאפ.",
      "אחרי החיבור לחץ על סרוק ג׳ימייל או סרוק וואטסאפ.",
      "בדוק את המדדים ואת התשלומים הפתוחים בהמשך הדף.",
    ],
    buttons: [
      { label: "סרוק ג׳ימייל", explanation: "מחפש חשבוניות חדשות במייל ומוסיף אותן למערכת." },
      { label: "סרוק וואטסאפ", explanation: "בודק הודעות ומסמכים שנשלחו בווטסאפ ומנסה לזהות חשבוניות." },
      { label: "חבר ג׳ימייל", explanation: "פותח חיבור מאובטח לחשבון גוגל שלך." },
      { label: "חבר וואטסאפ", explanation: "מעביר אותך למסך חיבור והגדרת וואטסאפ." },
      { label: "בדיקת מערכת", explanation: "בודק שכל החיבורים עובדים: ג׳ימייל, גוגל דרייב, גוגל שיטס, וואטסאפ ושרת." },
    ],
    commonMistakes: [
      "להריץ סריקה לפני שחיברת ג׳ימייל.",
      "לצפות למסמכי וואטסאפ לפני שהוגדר מספר וואטסאפ.",
      "לסגור את הדף מיד אחרי התחלת סריקה ארוכה.",
    ],
    troubleshooting: [
      "אם ג׳ימייל לא מחובר: לחץ על חבר ג׳ימייל ואשר הרשאות.",
      "אם וואטסאפ לא מחובר: לחץ על חבר וואטסאפ והגדר מספר.",
      "אם גוגל שיטס נכשל: בדוק את החיבור בהגדרות והרשאות גוגל.",
      "אם סריקה נכשלה: לחץ על בדיקת מערכת ואז נסה שוב.",
    ],
    videoUrl: null,
    voiceText: "זהו לוח הבקרה. כאן בודקים שהמערכת מחוברת, מריצים סריקות ג׳ימייל ווואטסאפ, ורואים חשבוניות ותשלומים פתוחים. התחל מחיבור ג׳ימייל ווואטסאפ, ואז הרץ סריקה.",
    walkthroughSteps: [
      { title: "מצב חיבורים", text: "פה רואים אם המערכת מחוברת לג׳ימייל, גוגל דרייב, גוגל שיטס, וואטסאפ והמסד.", selector: "[data-help='system-connections']" },
      { title: "חיבור ג׳ימייל", text: "מצא את כפתור חיבור ג׳ימייל. אם ג׳ימייל כבר מחובר, עבור לשלב הבא.", selector: "[data-help='connect-gmail'], [data-help='system-connections']", requiredAction: true, actionText: "לחץ על אזור חיבור ג׳ימייל או ודא שהוא מחובר." },
      { title: "חיבור וואטסאפ", text: "מצא את כפתור חיבור וואטסאפ. אם וואטסאפ כבר מחובר, עבור לשלב הבא.", selector: "[data-help='connect-whatsapp'], [data-help='system-connections']", requiredAction: true, actionText: "לחץ על אזור חיבור וואטסאפ או ודא שהוא מחובר." },
      { title: "סריקת ג׳ימייל", text: "פה לוחצים כדי לחפש חשבוניות חדשות במייל.", selector: "[data-help='scan-gmail']", requiredAction: true, actionText: "לחץ על סריקת ג׳ימייל או סמן שבדקת את הכפתור." },
      { title: "סריקת וואטסאפ", text: "פה לוחצים כדי לסרוק הודעות ומסמכים מוואטסאפ.", selector: "[data-help='scan-whatsapp']", requiredAction: true, actionText: "לחץ על סריקת וואטסאפ או סמן שבדקת את הכפתור." },
      { title: "בדיקת חשבוניות", text: "אחרי סריקה בודקים חשבוניות ותשלומים פתוחים.", selector: "[data-help='integration-metrics']" },
      { title: "פתיחת גוגל שיטס", text: "אם יש קישור לטבלה, פתח אותו כדי לוודא שהנתונים נכתבו.", selector: "[data-help='sheets-reconciliation'], [data-help='integration-metrics']" },
      { title: "סיום ההדרכה", text: "סיימת את ההדרכה. עכשיו אפשר לעבוד לבד עם המערכת.", selector: "main, .container" },
    ],
  ...
  },
  {
    ...
    commonMistakes: ["להכניס אימייל שגוי.", "להוסיף אותו לקוח פעמיים.", "לא למלא מספר וואטסאפ כשצריך הודעות."],
  ...
  },
  {
    ...
    title: "חשבוניות",
    description: "בדף הזה רואים חשבוניות שנאספו מהמייל, וואטסאפ או העלאה ידנית.",
    ...
    buttons: [
      ...
      { label: "סרוק ג׳ימייל", explanation: "מחפש חשבוניות חדשות במייל." },
    ],
    commonMistakes: ["לסמן כשולם לפני בדיקת הסכום.", "להתעלם מחשבונית בלי קישור.", "לחפש חשבונית לפני שהסריקה הסתיימה."],
    troubleshooting: ["אם חשבונית חסרה, הרץ סריקה.", "אם אין קובץ בדרייב, בדוק חיבור דרייב.", "אם סכום לא נכון, פתח את המסמך המקורי ובדוק ידנית."],
    videoUrl: null,
  ...
  },
  {
    ...
    troubleshooting: ["אם ספק לא נכון, בדוק את המסמך המקורי.", "אם התשלום כפול, בדוק מקור ג׳ימייל ווואטסאפ.", "אם גוגל שיטס לא מתעדכן, הרץ בדיקת מערכת."],
    videoUrl: null,
  ...
  },
  {
    ...
    title: "ווטסאפ",
    description: "בדף הזה מחברים וואטסאפ ורואים הודעות שנכנסו למערכת.",
    usedFor: "חיבור וואטסאפ עסקי, בדיקת הודעות וסריקת מסמכים שהגיעו בווטסאפ.",
    steps: ["בדוק אם וואטסאפ מחובר.", "אם לא, הגדר מספר ושלח הודעת בדיקה.", "ודא שה-webhook פעיל.", "שלח מסמך ניסיון.", "חזור לדשבורד ולחץ סריקת וואטסאפ."],
    buttons: [
      { label: "חבר וואטסאפ", explanation: "מחבר את המערכת לחשבון הווטסאפ העסקי שלך." },
      { label: "שלח בדיקה", explanation: "שולח הודעת ניסיון כדי לבדוק שהחיבור עובד." },
      { label: "סריקת וואטסאפ", explanation: "סורק הודעות ומסמכים שנכנסו." },
    ],
    commonMistakes: ["להגדיר מספר בלי קידומת מדינה.", "לשלוח קובץ לפני שהחיבור עובד.", "לא לבדוק שהודעת בדיקה התקבלה."],
    troubleshooting: ["אם וואטסאפ לא מחובר, בדוק מספר והגדרות Twilio.", "אם מסמך לא נקלט, שלח שוב PDF ברור.", "אם אין תגובה, בדוק מערכת מהדשבורד."],
    videoUrl: null,
    voiceText: "בדף ווטסאפ מחברים את המספר העסקי ובודקים הודעות. אחרי החיבור אפשר לסרוק מסמכים שהגיעו בווטסאפ.",
    walkthroughSteps: [{ title: "חיבור וואטסאפ", text: "כאן בודקים ומגדירים את חיבור הווטסאפ.", selector: ".container, main" }],
    supportNote: defaultSupportNote,
  },
  {
    pageKey: "settings",
    ...
    usedFor: "בודקים חיבור ג׳ימייל, דרייב, שיטס, וואטסאפ והגדרות כלליות של העסק.",
    steps: ["בדוק אילו חיבורים ירוקים.", "חבר מחדש שירות שלא עובד.", "עדכן פרטי עסק אם צריך.", "שמור שינויים.", "חזור לדשבורד והריץ בדיקת מערכת."],
    buttons: [
      { label: "חבר ג׳ימייל", explanation: "מחבר את חשבון גוגל למייל, דרייב ושיטס." },
      { label: "נתק", explanation: "מנתק חיבור קיים. השתמש בזה רק אם צריך לחבר מחדש." },
      { label: "שמור", explanation: "שומר את השינויים בדף." },
    ],
    commonMistakes: ["לנתק ג׳ימייל בלי לחבר מחדש.", "לא לשמור אחרי שינוי.", "להשתמש בחשבון גוגל לא נכון."],
    troubleshooting: ["אם חיבור נכשל, נסה להתנתק ולהתחבר מחדש.", "אם גוגל שיטס נכשל, ודא שאישרת הרשאות גוגל.", "אם שינוי לא נשמר, רענן ונסה שוב."],
    videoUrl: null,
  ...
  },
  {
    ...
    steps: ["בדוק אם יש כשל אדום.", "קרא את סיבת הכשל.", "חזור לדשבורד ולחץ בדיקת מערכת.", "תקן חיבור חסר.", "הרץ סריקה מחדש."],
    buttons: [
      { label: "בדוק מערכת", explanation: "בודק את כל החיבורים החשובים." },
      { label: "אמת גוגל שיטס", explanation: "בודק שהטבלה מקבלת נתונים." },
    ...
    troubleshooting: ["אם ג׳ימייל נכשל, חבר מחדש.", "אם דרייב נכשל, בדוק הרשאות.", "אם מסד הנתונים נכשל, המתן רגע ורענן."],
    videoUrl: null,
  ...
  },
  {
    ...
    title: "השלמת חשבוניות",
    description: "בדף הזה משלימים מסמכים שחסרים בהם שדות חובה או שדורשים אישור לפני שיופיעו במסך חשבוניות.",
    usedFor: "השלמת ספק, סכום, תאריך, סוג מסמך ומטבע — ואישור מסמכים שממתינים לבדיקה.",
    steps: ["בדוק אילו שדות חסרים לפי רשימת הסיבות.", "פתח את המסמך המקורי.", "השלם את השדות החסרים או אשר את המסמך.", "ודא שהמסמך עבר אוטומטית למסך חשבוניות."],
    buttons: [
      { label: "פתח מסמך", explanation: "פותח את המסמך המקורי לבדיקה." },
      { label: "אשר והשלם", explanation: "מאשר מסמך שממתין לאישור ומעביר אותו למסך חשבוניות." },
    ],
    commonMistakes: ["להשאיר מסמך חסר במסך חשבוניות.", "לאשר מסמך לפני שכל השדות החובה מלאים.", "לערבב בין תשלומים לספקים לבין השלמת חשבוניות."],
    troubleshooting: ["אם חסר סכום, בדוק את המסמך המקורי.", "אם ספק לא זוהה, אשר או תקן את שם הספק.", "אם המסמך לא עבר אוטומטית, ודא שכל השדות החובה מלאים."],
    videoUrl: null,
    voiceText: "השלמת חשבוניות מציגה מסמכים שחסרים בהם שדות או שדורשים אישור. השלם את השדות ואשר — והמסמך יעבור אוטומטית למסך חשבוניות.",
...
export const fallbackHelpContent: PageHelpContent = {
  ...
  beginnerExplanation: "אם זו הפעם הראשונה שלך, התחל מחיבור ג׳ימייל ווואטסאפ בלוח הבקרה. אחר כך הרץ סריקה ובדוק את התוצאות.",
  advancedExplanation: "משתמשים מנוסים יכולים לבדוק חיבורים, מקורות נתונים, קישורי דרייב וסטטוסי שיטס לפני טיפול ידני.",
  description: "כאן תקבל הסבר קצר על הדף הנוכחי ומה כדאי לעשות.",
  usedFor: "המערכת עוזרת לאסוף חשבוניות, משימות והודעות ממייל, וואטסאפ, דרייב ושיטס.",
